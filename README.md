...
<img width="764" height="500" alt="NSMLab drawio" src="https://github.com/user-attachments/assets/12032a79-58b8-43ac-b5d1-12acc30c5edb" />
...
This lab expansion provided valuable hands-on experience with installing and configuring Suricata to monitor internal traffic. I learned the importance of proper configurations within Suricata files, including the correct network interface, rule paths, and HOME_NET values, as misconfigurations prevented the IDS from detecting activity. Creating custom detection rules for ICMP, SYN scans, and DNS queries also improved my understanding of how IDS signatures identify suspicious behaviors. 

Capturing traffic with Wireshark allowed me to validate IDS alerts at the packet level, improving my understanding of ICMP traffic, network scans generated by nmap, and DNS query activity. Additionally, forwarding IDS alerts to Splunk centralized logging for further investigations.

Overall, this project strengthened my understanding of creating IDS rules to detect network activity, validating these alerts through packet analysis, and integrating a SIEM to support real-world SOC workflows.
